    ...
    <section class="vs-hero-wrapper  ">
        <div class="vs-hero-carousel" data-height="770" data-container="1900" data-slidertype="responsive"
            ...
            <div class="ls-slide" data-ls="duration:12000; transition2d:5; kenburnszoom:in; kenburnsscale:1.1;">
                <img width="1920" height="770" src="/img/hero/hero-1-1.jpg" class="ls-bg" alt="bg"
                    decoding="async">
                <ls-layer
            ...
            <div class="ls-slide" data-ls="duration:12000; transition2d:5; kenburnszoom:out; kenburnsscale:1.1;">
                <img width="1920" height="770" src="/img/hero/hero-1-2.jpg" class="ls-bg" alt="bg"
                    decoding="async">
                <h1 style="font-size:60px; stroke:#000; stroke-width:0px; text-align:center; font-style:normal; text-decoration:none; text-transform:none; font-weight:600; letter-spacing:0px; background-position:0% 0%; background-repeat:no-repeat; background-clip:border-box; overflow:visible; font-family:'Fredoka', sans-serif; line-height:60px; color:#ffffff; top:284px; left:312px; width:711px; -webkit-background-clip:border-box;"
                    class="ls-l ls-hide-tablet ls-hide-phone ls-text-layer"
                    data-ls="offsetxin:-100; delayin:200; easingin:easeOutQuint; offsetxout:-100; easingout:easeOutQuint;">
            ...
            <!-- Slide 3-->
            <div class="ls-slide" data-ls="duration:12000; transition2d:5; kenburnszoom:in; kenburnsscale:1.1;">
                <img width="1920" height="770" src="/img/hero/hero-1-3.jpg" class="ls-bg" alt="bg"
                    decoding="async">
                <h1 style="font-size:60px; stroke:#000; stroke-width:0px; text-align:center; font-style:normal; text-decoration:none; text-transform:none; font-weight:600; letter-spacing:0px; background-position:0% 0%; background-repeat:no-repeat; background-clip:border-box; overflow:visible; font-family:'Fredoka', sans-serif; line-height:60px; color:#ffffff; top:284px; left:312px; width:711px; -webkit-background-clip:border-box;"
                    class="ls-l ls-hide-tablet ls-hide-phone ls-text-layer"
                    data-ls="offsetxin:-100; delayin:200; easingin:easeOutQuint; offsetxout:-100; easingout:easeOutQuint;">
            ...
            <div class="row gx-70 align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="img-box1">
                        ...
                        <div class="img-1 mega-hover"><img src="/img/about/ab-1-1.jpg" alt="about"></div>
                        <div class="img-2 mega-hover"><img src="/img/about/ab-1-2.jpg" alt="about"></div>
                        <div class="img-3 mega-hover"><img src="/img/about/ab-1-3.jpg" alt="about"></div>
                        <div class="img-4 mega-hover"><img src="/img/about/ab-1-4.jpg" alt="about"></div>
                    </div>
                </div>
                    ...
                    <div class="row gx-70 justify-content-center justify-content-lg-start text-md-start">
                        <div class="col-auto">
                            <div class="vs-media media-style1">
                                <div class="media-icon"><img src="/img/icon/ab-1-1.svg" alt="icon"></div>
                        ...
                        <div class="col-auto">
                            <div class="vs-media media-style1">
                                <div class="media-icon"><img src="/img/icon/ab-1-2.svg" alt="icon"></div>
                                <div class="media-body">
...
==============================-->
            ...
            <div class="row vs-carousel" data-slide-show="4" data-ml-slide-show="3" data-lg-slide-show="3"
                ...
                <div class="service-style1 col-xl-3">
                    <div class="service-body">
                        <div class="service-img"><a href="service-details.html"><img src="/img/service/sr-1-1.jpg"
                                    alt="service"></a></div>
                        <div class="service-content">
                            <div class="service-icon"><img src="/img/icon/sr-1-1.svg" alt="icon"></div>
                ...
                <div class="service-style1 col-xl-3">
                    <div class="service-body">
                        <div class="service-img"><a href="service-details.html"><img src="/img/service/sr-1-2.jpg"
                                    alt="service"></a></div>
                        <div class="service-content">
                            <div class="service-icon"><img src="/img/icon/sr-1-2.svg" alt="icon"></div>
                ...
                <div class="service-style1 col-xl-3">
                    <div class="service-body">
                        <div class="service-img"><a href="service-details.html"><img src="/img/service/sr-1-3.jpg"
                                    alt="service"></a></div>
                        <div class="service-content">
                            <div class="service-icon"><img src="/img/icon/sr-1-3.svg" alt="icon"></div>
                ...
                <div class="service-style1 col-xl-3">
                    <div class="service-body">
                        <div class="service-img"><a href="service-details.html"><img src="/img/service/sr-1-4.jpg"
                                    alt="service"></a></div>
                        <div class="service-content">
                            <div class="service-icon"><img src="/img/icon/sr-1-4.svg" alt="icon"></div>
    ...
    <div data-bg-src="/img/bg/bg-h-1-1.jpg"><!--==============================
   About Area  
    ==============================-->
        <section class=" space-top space-extra-bottom">
            <div class="container">
                <div class="row align-items-center justify-content-between flex-row-reverse">
                    <div class="col-lg-6 text-center text-lg-end">
                        <div class="img-box2">
                            <div class="transform-banner"><img src="/img/about/ab-2-1.jpg" alt="about"></div>
    ...
    Schedule Area
    ==============================-->
    <section class=" space-extra" data-bg-src="/img/bg/table-bg-1-1.jpg">
        <div class="container">
            ...
            <div class="row gx-50 gy-gx">
                <div class="col-md-6">
                    <div class="class-style1">
                        <div class="class-img"><a href="class-details.html"><img src="/img/class/cl-1-1.jpg"
                                    alt="class"></a></div>
                ...
                <div class="col-md-6">
                    <div class="class-style1">
                        <div class="class-img"><a href="class-details.html"><img src="/img/class/cl-1-2.jpg"
                                    alt="class"></a></div>
                        <div class="class-content">
                ...
                <div class="col-md-6">
                    <div class="class-style1">
                        <div class="class-img"><a href="class-details.html"><img src="/img/class/cl-1-3.jpg"
                                    alt="class"></a></div>
                        <div class="class-content">
                ...
                <div class="col-md-6">
                    <div class="class-style1">
                        <div class="class-img"><a href="class-details.html"><img src="/img/class/cl-1-4.jpg"
                                    alt="class"></a></div>
                        <div class="class-content">
                ...
                <div class="col-lg-6 pb-3 pb-xl-0">
                    <div class="img-box3">
                        <div class="img-1 mega-hover">
                            <img src="/img/about/faq-1-1.jpg" alt="FAQ">
        ...
        <div class="container">
            <div class="row flex-row-reverse align-items-center gx-60">
                <div class="col-lg-6 text-center text-lg-start mb-40 mb-lg-0">
                    <img src="/img/about/testi-1-1.png" alt="childrens" class="w-100">
                </div>
                <div class="col-lg-6">
                    <div class="title-area text-center">
    ...
    Newsletter Area
    ==============================-->
    <section class="form-wrap1 space" data-bg-src="/img/bg/newsletter-bg-1-1.png">
        <div class="container">
            <div class="title-area text-center">
                <div class="mb-3 pb-1"><img src="/img/icon/bell-1-1.svg" alt="bell icon"></div>
            ...
            <form action="index.html#" class="form-style1">
