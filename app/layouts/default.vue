<template>
  <div>
    ...
    <div class="vs-menu-wrapper">
        <div class="vs-menu-area text-center">
            ...
            <div class="mobile-logo">
                <a href="index.html"><img src="/img/logo.svg" alt="Kiddino"></a>
            </div>
        ...
        <div class="sidemenu-content">
            ...
            <div class="widget  ">
                <div class="widget-about">
                    <div class="footer-logo"><img src="/img/logo.svg" alt="Kiddino"></div>
            ...
            <div class="widget  ">
                ...
                <div class="recent-post-wrap">
                    <div class="recent-post">
                        <div class="media-img">
                            <a href="blog-details.html"><img src="/img/blog/recent-post-1-1.jpg"
                                    alt="Blog Image"></a>
                        </div>
                    ...
                    <div class="recent-post">
                        <div class="media-img">
                            <a href="blog-details.html"><img src="/img/blog/recent-post-1-2.jpg"
                                    alt="Blog Image"></a>
                        </div>
                        <div class="media-body">
                            <div class="recent-post-meta">
                    ...
                    <div class="recent-post">
                        <div class="media-img">
                            <a href="blog-details.html"><img src="/img/blog/recent-post-1-3.jpg"
                                    alt="Blog Image"></a>
                        </div>
                        <div class="media-body">
                            <div class="recent-post-meta">
                                ...
                                <ul>
                                    ...
                                    <li class="menu-item-has-children mega-menu-wrap">
                                        ...
                                        <ul class="mega-menu">
                                            ...
                                            <li><a href="index.html#">Pagelist 2</a>
                                                <ul>
                                                    <li><a href="class-details.html">Class Details</a></li>
                                            ...
                                            <li><a href="index.html#">Pagelist 3</a>
                                                <ul>
                                                    <li><a href="event-details.html">Event Details</a></li>
                                                    <li><a href="shop.html">Shop</a></li>
                                                    <li><a href="shop-details.html">Shop Details</a></li>
                                            ...
                                            <li><a href="index.html#">Pagelist 4</a>
                                                <ul>
                                                    <li><a href="blog.html">Blog</a></li>
                                                    <li><a href="blog-details.html">Blog Details</a></li>
                                                    <li><a href="registration.html">Registration</a></li>
    ...
    <!--==============================
			Footer Area
	==============================-->
    <footer class="footer-wrapper footer-layout1" data-bg-src="/img/bg/footer-bg-1-1.png">
        <div class="footer-top">
            <div class="container">
                <div class="row gx-60 gy-4 text-center text-lg-start justify-content-between align-items-center">
                    <div class="col-lg"><a href="/"><img src="/img/logo-2.svg" alt="logo"></a></div>
                    <div class="col-lg-auto">
                        <h3 class="h4 mb-0 text-white"><img src="/img/icon/check-list.svg" alt="icon"
                    ...
                    <div class="col-lg-4">
                        <div class="widget footer-widget">
                            <div class="widget-about">
                                ...
                                <p class="map-link"><img src="/img/icon/map.svg" alt="svg">First Floor, 10A
                                    Chandos Street London New Town W1G 9LE</p>
                                <div class="sidebar-gallery">
                                    <div class="gallery-thumb">
                                        <img src="/img/widget/gal-2-1.jpg" alt="Gallery Image" class="w-100">
                                        <a href="/img/widget/gal-2-1.jpg" class="popup-image gal-btn"><i
                                                class="fal fa-plus"></i></a>
                                    </div>
                                    <div class="gallery-thumb">
                                        <img src="/img/widget/gal-2-2.jpg" alt="Gallery Image" class="w-100">
                                        <a href="/img/widget/gal-2-2.jpg" class="popup-image gal-btn"><i
                                                class="fal fa-plus"></i></a>
                                    </div>
                                    <div class="gallery-thumb">
                                        <img src="/img/widget/gal-2-3.jpg" alt="Gallery Image" class="w-100">
                                        <a href="/img/widget/gal-2-3.jpg" class="popup-image gal-btn"><i
                                                class="fal fa-plus"></i></a>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="copyright-wrap">
            <div class="container">
                <div class="row flex-row-reverse gy-3 justify-content-between align-items-center">
                    ...
                    <div class="col-lg-auto">
                        <p class="copyright-text ">Copyright &copy; 2023 <a href="/">Kiddino</a>. All Rights
